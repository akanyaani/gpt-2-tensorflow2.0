...
class MultiHeadAttention(tf.keras.layers.Layer):
    def __init__(self, d_model, num_heads, att_dropout=0.0, scale=False):
    ...
    def call(self, x, mask=None, past_layer=None):
        x = self.c_attn(x)
        ...
        scaled_attention, attention_weights = self.multihead_attention(query, key, value, mask)
